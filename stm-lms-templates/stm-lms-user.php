...
<div class="stm-lms-wrapper stm-lms-wrapper-user user-account-page child">
  ...
  <div class="container">
    ...
    ?>
    <?php echo do_shortcode('[bookly-customer-cabinet tabs="appointments" appointments="date,service,staff,price,status" profile="name,email,phone,birthday,address,wp_password,delete"]'); ?>
  </div>
</div>
