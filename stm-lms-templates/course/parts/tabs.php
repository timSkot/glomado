...
<?php
$tabs                 = array();
$tabs['description']  = esc_html__( 'Description', 'masterstudy-child' );
//$tabs['curriculum']   = esc_html__( 'Curriculum', 'masterstudy-child' );
$tabs['glokit']       = esc_html__( 'GLOkit', 'masterstudy-child' );
$tabs['faq']          = esc_html__( 'FAQ', 'masterstudy-child' );
$tabs['announcement'] = esc_html__( 'Announcement', 'masterstudy-child' );
$tabs['reviews']      = esc_html__( 'Reviews', 'masterstudy-child' );
